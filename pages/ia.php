...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['article_url'])) {
    $res = add_article_from_url('ia', $_POST['article_url']);
    if (!$res['ok']) {
...
<main class="mx-auto max-w-6xl px-4">
  <section class="panel">
    <div style="display: flex; justify-content: space-between; align-items: start; gap: 20px; flex-wrap: wrap;">
      <div>
        <h1 class="text-3xl font-bold">🤖 Intelligence Artificielle</h1>
        <p class="text-zinc-300">Articles et actualités sur l'IA, automatiquement synchronisés depuis des flux RSS.</p>
      </div>
